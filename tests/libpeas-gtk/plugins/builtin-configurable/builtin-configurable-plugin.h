...
#ifndef __TESTING_BUILTIN_CONFIGURABLE_PLUGIN_H__
#define __TESTING_BUILTIN_CONFIGURABLE_PLUGIN_H__
...
#endif /* __TESTING_BUILTIN_CONFIGURABLE_PLUGIN_H__ */
