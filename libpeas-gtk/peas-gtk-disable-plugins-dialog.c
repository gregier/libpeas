...
build_multiple_dependent_plugins (PeasGtkDisablePluginsDialog *dialog)
{
  ...
  gtk_message_dialog_format_secondary_text (GTK_MESSAGE_DIALOG (dialog),
      ...
      peas_plugin_info_get_name (dialog->plugin_info));
  ...
  for (dep_plugin = dialog->dep_plugins; dep_plugin != NULL;
...
build_single_dependent_plugin (PeasGtkDisablePluginsDialog *dialog)
{
  ...
  gtk_message_dialog_format_secondary_text (GTK_MESSAGE_DIALOG (dialog),
      ...
      peas_plugin_info_get_name (dialog->plugin_info),
      peas_plugin_info_get_name (dialog->dep_plugins->data),
      peas_plugin_info_get_name (dialog->plugin_info),
      peas_plugin_info_get_name (dialog->dep_plugins->data));
}
                                              ...
                                              GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_PLUGIN_INFO:
      dialog->plugin_info = g_value_get_pointer (value);
      break;
    case PROP_DEPENDENT_PLUGINS:
      dialog->dep_plugins = g_value_get_pointer (value);
      break;
    default:
                                              ...
                                              GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_PLUGIN_INFO:
      g_value_set_pointer (value, dialog->plugin_info);
      break;
    case PROP_DEPENDENT_PLUGINS:
      g_value_set_pointer (value, dialog->dep_plugins);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
peas_gtk_disable_plugins_dialog_constructed (GObject *object)
{
  ...
  if (dialog->dep_plugins->next == NULL)
...
peas_gtk_disable_plugins_dialog_finalize (GObject *object)
{
  ...
  g_list_free (dialog->dep_plugins);
